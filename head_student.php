<?php
    ...
    if((isset($_SESSION['zalogowany'])) && ($_SESSION['zalogowany'] == true) && $_SESSION['status'] == "prowadzacy")
    {
...
<?php
    echo "<div class='head'>";
    	echo "<div class='head_nazwa'>";
    		echo "Witaj ".$_SESSION['student_imie']." ".$_SESSION['student_nazwisko'];
    	echo "!</div>";
    	echo "<a href='logout.php'>";
    		echo "<div class='wyloguj'>Wyloguj się!</div>";
    	echo "</a>";
		echo "<div style='clear: both;'></div>";
    	echo "<div id='head_grupa'>";
    		echo "<b>Grupa laboratoryjna: </b>".$_SESSION['student_grupa_laboratoryjna'];
